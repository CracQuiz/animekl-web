				...
				<img
					src={
						trendingContent?.backdrop_path
							...
							: "/ONE_PIECE_BANNER.png" // Hình ảnh dự phòng nếu không có backdrop
					}
					alt='Hero img'
				...
				<div className='absolute top-0 left-0 w-full h-full flex flex-col justify-center px-8 md:px-16 lg:px-32'>
					...
					<div className='max-w-2xl'>
						<h1 className='mt-4 text-6xl font-extrabold text-balance'>
							{trendingContent?.title || trendingContent?.name || "ONE PIECE"}
						</h1>
						...
						<p className='mt-4 text-lg'>
							{trendingContent?.overview
								? trendingContent?.overview.length > 200
									...
									: trendingContent?.overview
								: "Với chiếc mũ rơm và nhóm bạn đủ thành phần, hải tặc trẻ Monkey D. Luffy có hành trình săn kho báu hoành tráng trong bản chuyển thể người đóng này của bộ manga nổi tiếng."}
						</p>
					</div>
